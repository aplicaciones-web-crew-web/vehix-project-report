...
| US24 | Lengüage técnico | **Como** mecánico automotriz **quiero** tener los codigos de error asociados a las fallas **para** identificarlas rapidamente. | **Escenario 1: Visualizar código de error de las fallas del vehículo** **Dado** que el mecánico automotriz posee el PLAN PRO **Cuando** realiza un diagnóstico **Entonces** visualiza las fallas, sus código de error y una descripción de cada uno. **Escenario 2: Bloqueo de código de error de las fallas del vehículo** **Dado** que el mecánico automotriz posee el PLAN STANDARD **Cuando** realiza un diagnóstico **Entonces** no visualiza los código de error y se le informa adquirir el PLAN PRO. | EP05 |
